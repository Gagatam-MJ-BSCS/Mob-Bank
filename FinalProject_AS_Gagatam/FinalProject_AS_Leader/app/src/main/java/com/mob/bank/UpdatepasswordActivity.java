...
public class UpdatepasswordActivity extends  AppCompatActivity  { 
	...
	private EditText tbConfirmNewPassword;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		tbNewPassword = (EditText) findViewById(R.id.tbNewPassword);
		textview3 = (TextView) findViewById(R.id.textview3);
		tbConfirmNewPassword = (EditText) findViewById(R.id.tbConfirmNewPassword);
		...
		btnConfirm.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if (tbNewPassword.getText().toString().equals("") || tbConfirmNewPassword.getText().toString().equals("")) {
					if (tbNewPassword.getText().toString().equals("")) {
						((EditText)tbNewPassword).setError("New password is required.");
					}
					if (tbConfirmNewPassword.getText().toString().equals("")) {
						((EditText)tbConfirmNewPassword).setError("Confirm new password is required.");
					}
				}
				else {
					if (tbNewPassword.getText().toString().length() < 5) {
						((EditText)tbNewPassword).setError("Password should be atleast 5 characters in length.");
					}
					else {
						if (tbNewPassword.getText().toString().equals(tbConfirmNewPassword.getText().toString())) {
							
						}
						else {
							((EditText)tbNewPassword).setError("Password is not match.");
						}
					}
				}
			}
	...
	public void _design () {
		tbNewPassword.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int c, int d) { this.setCornerRadius(a); this.setStroke(b, c); this.setColor(d); return this; } }.getIns((int)5, (int)2, 0xFF000000, 0xFFFFFFFF));
		tbConfirmNewPassword.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int c, int d) { this.setCornerRadius(a); this.setStroke(b, c); this.setColor(d); return this; } }.getIns((int)5, (int)2, 0xFF000000, 0xFFFFFFFF));
	}
