...
public class MainActivity extends  AppCompatActivity  { 
	...
	private ArrayList<HashMap<String, Object>> tblAccountsLM = new ArrayList<>();
	...
	private LinearLayout tbBoxUsername;
	private LinearLayout tbBoxPassword;
	...
	private DatabaseReference fdbAcounts = _firebase.getReference("accounts");
	private ChildEventListener _fdbAcounts_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		boxLoading = (LinearLayout) findViewById(R.id.boxLoading);
		boxForm = (LinearLayout) findViewById(R.id.boxForm);
		progressbar1 = (ProgressBar) findViewById(R.id.progressbar1);
		textview2 = (TextView) findViewById(R.id.textview2);
		textview1 = (TextView) findViewById(R.id.textview1);
		tbBoxUsername = (LinearLayout) findViewById(R.id.tbBoxUsername);
		tbBoxPassword = (LinearLayout) findViewById(R.id.tbBoxPassword);
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (tbEmail.getText().toString().equals("") || tbPassword.getText().toString().equals("")) {
					d.setTitle("Error");
					d.setMessage("All fields are required.");
					...
					pd.setMessage("Logging to your account, Please wait.");
					pd.setCancelable(false);
					pd.setCanceledOnTouchOutside(false);
					pd.show();
					fbauth.signInWithEmailAndPassword(tbEmail.getText().toString(), tbPassword.getText().toString()).addOnCompleteListener(MainActivity.this, _fbauth_sign_in_listener);
				}
			}
		});
		...
		_fdbAcounts_child_listener = new ChildEventListener() {
			@Override
		...
		fdbAcounts.addChildEventListener(_fdbAcounts_child_listener);
	...
	public void _design () {
		tbBoxUsername.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int c, int d) { this.setCornerRadius(a); this.setStroke(b, c); this.setColor(d); return this; } }.getIns((int)5, (int)2, 0xFF000000, 0xFFFFFFFF));
		tbBoxPassword.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int c, int d) { this.setCornerRadius(a); this.setStroke(b, c); this.setColor(d); return this; } }.getIns((int)5, (int)2, 0xFF000000, 0xFFFFFFFF));
	}
	
	
	public void _loadAllAccounts () {
		boxLoading.setVisibility(View.VISIBLE);
		boxForm.setVisibility(View.GONE);
		fdbAcounts.addListenerForSingleValueEvent(new ValueEventListener() {
			@Override
			public void onDataChange(DataSnapshot _dataSnapshot) {
				tblAccountsLM = new ArrayList<>();
				try {
					GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
					for (DataSnapshot _data : _dataSnapshot.getChildren()) {
						HashMap<String, Object> _map = _data.getValue(_ind);
						tblAccountsLM.add(_map);
					}
				}
				catch (Exception _e) {
					_e.printStackTrace();
				...
				boxForm.setVisibility(View.VISIBLE);
			}
			@Override
